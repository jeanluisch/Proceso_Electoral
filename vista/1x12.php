 ...
 if ( isset($_SESSION['usuarioActivo']) != TRUE ) {
  ...
  if ( isset($_GET['id_1x12']) ){
    //enviar los datos de la persona
     $id_1x12 = $_GET['id_1x12'];
    
    $_SESSION['id_1x12_resp'] = $id_1x12;
  }
?>
...
<html lang="es">
  ...
  <body class="nav-md">
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2> Lista de Electores Sin Responsables Asignados </h2>
                  ...
                  <div class="x_content">
                    ...
                    <input type="hidden" name="id_1x12" id="id_1x12" value="<?php echo $id_1x12 ?>"  >
                    <!--
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2> Lista de miembros 1x12 Asignados </h2>
                      <ul class="nav navbar-right panel_toolbox">
                        <li><a class="collapse-link"><i class="fa fa-chevron-down"></i></a>
                        </li>
                        <li><a class="close-link"><i class="fa fa-close"></i></a>
                  ...
                  <div class="x_content">
                    ...
                    -->
                    <table id="datatable-miembros" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                          <th>Cédula</th>
                          <th>Nombres</th>
    ...
    <script src="../js/1x12/1x12_proceso.js"></script>
    <!-- JS script
